...
# FIX 11: CORS - Restrict origins with safe parsing and Pages support
DEFAULT_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://localhost:8080",
    "https://legal-ai-agent.pages.dev",
]
...
# Optional regex for preview/staging domains (example: https://<branch>.pages.dev)
ALLOWED_ORIGIN_REGEX = os.getenv("ALLOWED_ORIGIN_REGEX", r"^https://.*\.pages\.dev$")
